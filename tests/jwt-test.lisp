...
(deftest hs256-roundtrip
  (let* ((key (encoding-protocol:encode "secret-key-123456"))
...
(deftest inspect-unverified
  (let* ((key (encoding-protocol:encode "k"))
...
(deftest expired-p-verify-hs
  ...
  (let* ((key (encoding-protocol:encode "secret-key-123456789012345678901234"))
    ...
    (ok (signals (expired-p tok :verify t :algorithm :hs256
                                :key (encoding-protocol:encode "wrong-key"))))))
